...
<head>
  <meta charset="UTF-8">
  <title><?= join(' | ', ['Our Approach', config('app_name', true)]) ?></title>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card mb-5 mb-lg-0">
            <div class="card-body">
              <h5 class="card-title text-muted text-uppercase text-center">Ethical Hacking</h5>
        ...
        <div class="col-lg-4">
          <div class="card mb-5 mb-lg-0">
            <div class="card-body">
              <h5 class="card-title text-muted text-uppercase text-center">Phising</h5>
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title text-muted text-uppercase text-center">Malware</h5>
