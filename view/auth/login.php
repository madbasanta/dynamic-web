		...
		<div class="container">
			<div class="row">
				<div class="col-md-5">
					<div class="card mt-3">
						<div class="card-body">
							<h5>Enter your log in credentials</h5> <br>
							<form action="/sign-in?page=login" method="post">
								...
								<div class="form-group mb-0">
									<button class="btn btn-danger py-1 px-4">Sign in</button>
						...
						<div class="card-body">
							...
							<form action="/sign-up" method="post" id="sign-up-form">
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group mb-0">
											<button class="btn btn-info py-1 px-4">Sign up</button>
										</div>
									</div>
								</div>
							</form>
