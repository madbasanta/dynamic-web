<aside id="side-bar">
	<div class="list-group">
		<div class="list-group-item rounded-0">
			<div class="d-block py-2" style="line-height: 50px;">
				<h5 class="mb-0"><?= config('app_name') ?> <br> <small class="text-muted">Admin Panel</small></h3>
			</div>
		</div>
	</div>
	...
	<div class="list-group left-side-bar-pages">
		...
		<a href="/admin/attendies" data-slug="attendies" class="list-group-item list-group-item-action  rounded-0">
			<i class="fa fa-users w-30"></i> Attendies
		</a>
	</div>
</aside>
		...
		<div class="card-body">
			...
			<div class="right float-right d-flex">
				...
				<div style="width: 50px;height: 50px;border-radius: 50%;overflow: hidden;margin: -15px 0;text-align: center;">
					<img src="/assets/img/no-user.png" alt="avatar" style="max-height: 100%;max-width: 100%;">
				</div>
			</div>
		</div>
	</div>
